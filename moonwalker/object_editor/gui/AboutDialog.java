...
public class AboutDialog
{
	...
	public AboutDialog(String mwoeVersion, Window owner)
	{
		dialog = new JDialog(owner, ModalityType.DOCUMENT_MODAL);
		dialog.setTitle("Moonwalker Object Editor");
		...
		centerPanel.add(new JLabel("Moonwalker Object Editor v" + mwoeVersion + " by MKull"));
		...
		bGithub.addActionListener(e -> 
		{
			try
			{
				...
				if (desktop != null && desktop.isSupported(Desktop.Action.BROWSE))
					desktop.browse(new URI("https://github.com/mkullassUG/MoonwalkerObjectEditor"));
			}
			catch (Exception exc)
			{
				exc.printStackTrace();
